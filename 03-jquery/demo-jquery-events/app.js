...
function logTarget() {
  console.log('this', this);
  console.log('the preceding is the exact same thing we would get back from event.target with a vanilla event listener')
  console.log('$(this)', $(this));
  console.log('immediately before this log is the jQuery version of the event target');
